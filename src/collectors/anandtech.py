"""AnandTech collector for CHIPS Act intelligence."""
...
class AnandTechCollector(BaseCollector):
    """Collector for AnandTech articles."""
    
    def __init__(self):
        super().__init__()
        self.base_url = "https://www.anandtech.com"
        self.search_url = "https://www.anandtech.com/search"
    ...
    def collect(self) -> List[Dict[str, Any]]:
        """Collect CHIPS Act related articles from AnandTech."""
        logger.info("Starting AnandTech collection...")
        ...
        logger.info(f"AnandTech collection completed. Found {len(collected_data)} articles.")
    ...
    def _search_articles(self, keyword: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if not response or response.status_code != 200:
                logger.warning(f"Failed to search AnandTech for {keyword}")
                return articles
            ...
            logger.error(f"Error searching AnandTech: {e}")
    ...
    def _parse_search_results(self, html_content: str, keyword: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Error parsing AnandTech results: {e}")
